...
{
    static ABMgr instance;
    public static ABMgr Instance {
        get {
            if (instance == null) {
                GameObject go = new GameObject("ABMgr");
                instance = go.AddComponent<ABMgr>();
    ...
    /// 获取AB包加载路径
    /// </summary>
    private string StreamingPathUrl
    {
        get
        {
    ...
    private void LoadMainAB()
    {
        ...
        {
            //先判断有没有最新资源 没有则加载默认
            string path = File.Exists(PersistentPathUrl + MainName) ? PersistentPathUrl + MainName : StreamingPathUrl + MainName;
    ...
    private void LoadDependencies(string abName)
    {
        ...
        for (int i = 0; i < strs.Length; i++)
        {
            ...
            {
                string path = File.Exists(PersistentPathUrl + strs[i]) ? PersistentPathUrl+strs[i] : StreamingPathUrl+strs[i];
    ...
    public T LoadRes<T>(string abName, string resName) where T:Object
    {
        ...
        {
            string path = File.Exists(PersistentPathUrl + abName) ? PersistentPathUrl + abName : StreamingPathUrl + abName;
            AssetBundle ab = AssetBundle.LoadFromFile(path);
            abDic.Add(abName, ab);
        }
